...
class ReportsController extends \BaseController {
    ...
    public function individual(){
		...
		$pdf = PDF::loadView('pdf.individualemployee', compact( 'employee','organization'))->setPaper('a4');
    ...
    public function period_payslip()
  {
    ...
    $pdf = PDF::loadView('pdf.monthlySlip', compact('employee','transacts','allws','deds','earnings','period','currencies', 'organization'))->setPaper('a4');
    ...
    public function allowances(){
		...
		$pdf = PDF::loadView('pdf.allowanceReport', compact('allws','period','currencies', 'organization'))->setPaper('a4');
    ...
    public function deductions(){
		...
		$pdf = PDF::loadView('pdf.deductionReport', compact('deds','period','currencies', 'organization'))->setPaper('a4');
    ...
    public function payeReturns(){
		...
		$pdf = PDF::loadView('pdf.payeReport', compact('payes','total','currencies','period','organization'))->setPaper('a4');
   ...
   public function period_nssf()
    ...
    $branches=DB::table('bank_branches')
		...
		$pdf = PDF::loadView('pdf.remittanceReport', compact('rems','branches','total','currencies','period','organization'))->setPaper('a4', 'landscape');
     ...
     $branches=DB::table('bank_branches')
		...
		$pdf = PDF::loadView('pdf.remittanceReport', compact('rems','branches','total','emps','currencies','period','organization'))->setPaper('a4', 'landscape');
     ...
     $branches=DB::table('bank_branches')
		...
		$pdf = PDF::loadView('pdf.remittanceReport', compact('rems','total','branches','currencies','period','organization'))->setPaper('a4', 'landscape');
